...
const Dropzone = () => {
  ...
  return (
    <>
    <button
                    className="text-black background-transparent font-bold uppercase p-2 mr-5 text-sm outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150 hover:bg-slate-600 hover:text-white rounded-md bg-slate-200 absolute top-72 right-80"
                    type="button"
          ...
          {!files.length ? (
            ...
            <>
              <div className="relative">
                ...
                />
                <div
                  className="absolute top-0 right-0 cursor-pointer bg-gray-800 hover:bg-opacity-60 rounded-full text-white p-1"
                  onClick={() => setFiles([])}
                >
