...
const Sidebar = () => {
  ...
  return (
    <div className="bg-violet-50 border-r-2 border-r-pink-200 flex flex-col rounded-md justify-between sticky top-0 dark:bg-dark-secondary dark:border-r-2 dark:border-r-dark-border h-screen w-32 sm:w-16 md:w-32 lg:w-48">
